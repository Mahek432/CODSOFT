...
public class CourseManagementSystem {
    public static void main(String[] args) {
        ...
        courseDatabase.addCourse(new Course("DM801", "Intro to Discrete Mathematics", "Basic DM course", 30, "MWF 9-10AM"));
        courseDatabase.addCourse(new Course("os101", "Operating System I", "Basic os course", 25, "TTh 10-11:30AM"));

        studentDatabase.addStudent(new Student("S1", "Mahek"));
        studentDatabase.addStudent(new Student("S2", "Meshva"));
